  ...
  <div className="container mx-auto px-4">
    <div className="relative max-w-4xl mx-auto mb-14 px-6 md:px-10 py-10 md:py-14 rounded-3xl overflow-hidden bg-gradient-to-br from-primary via-primary to-blue-600 shadow-2xl border-4 border-primary/20">
      ...
      <div className="relative text-center">
        ...
        {/* Título con el estilo de Capacitaciones */}
        <h2 className="text-5xl md:text-7xl lg:text-8xl font-black text-primary-foreground mb-5 leading-none tracking-tight drop-shadow-lg">
          Ebooks<br />
          <span className="bg-gradient-to-r from-yellow-300 via-yellow-200 to-white bg-clip-text text-transparent">Premium</span>
        </h2>

        {/* Descripción adaptada */}
        <p className="text-xl md:text-2xl text-primary-foreground/90 font-medium max-w-2xl mx-auto leading-relaxed mb-8">
          Diseñado por el profesor Diego Machado y su equipo. Guías completas para entrenadores y jugadores que quieran elevar su nivel de competencia.
        </p>

        {/* Beneficios con estilo mejorado */}
        <div className="flex flex-wrap justify-center gap-6 text-sm md:text-base text-white/80 font-semibold">
          <span className="flex items-center gap-2"><Download className="w-5 h-5 text-yellow-300" /> Descarga instantánea</span>
          <span className="flex items-center gap-2">📧 Envío por email</span>
          <span className="flex items-center gap-2">📱 Todo dispositivo</span>
        </div>
      </div>
    </div>
